...
import { FiltersValidator, InFiltersValidator, SearchValidator } from 'src/modules/clients/dto/client-filter.dto';

export function getFilterClientMetadata(): Record<string, FilterType[]> {
